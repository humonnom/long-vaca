...
export const MatchScreen = ({ onNavigateToProfile }: MatchPageProps) => {
  return (
    <SafeAreaView style={styles.container}>
      {/* Header */}
      <View style={styles.header}>
        <Text style={styles.headerTitle}>매치</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.mainTitle}>매치 기능 준비 중</Text>
        <Text style={styles.subtitle}>
          곧 멋진 매치 기능으로 만나뵙겠습니다!
        </Text>
